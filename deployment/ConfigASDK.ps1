...
if (!$skipAppService) {
    Write-CustomVerbose -Message "You've chosen to deploy the App Service Resource Provider. This requires 18.5GB RAM"
    [INT]$totalRPMemoryRequired = [INT]$totalRPMemoryRequired + 18.5
}
