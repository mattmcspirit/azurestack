...
sudo apt-key adv --keyserver pool.sks-keyservers.net --recv-keys 5072E1F5apt-key add --keyserver pgp.mit.edu --recv-keys 5072E1F5

# Retrieve the latest APT repo for MySQL and save it
echo "deb http://repo.mysql.com/apt/ubuntu $(lsb_release -sc) mysql-8.0" | \
