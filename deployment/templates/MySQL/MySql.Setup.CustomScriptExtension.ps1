...
function Get-Package([string] $FileUri) {
...
function Install-MySqlServer {
    ...
    try {
        ...
        Get-Package -FileUri $MySqlInstallationPackageUri
...
try {
    ...
    $MySqlAdminCredential = New-Object System.Management.Automation.PSCredential($MySqlAdminUserName, (ConvertTo-SecureString -String $MySqlAdminPwd -AsPlainText -Force)) 
